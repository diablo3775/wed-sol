    ...
    >
      ...
      <Menu.Item key="1" style={{listStyle:"none",paddingLeft:4}} >
        ...
        <Menu.Item key="2" style={{listStyle:"none",paddingLeft:4}}>
          <Size>
          <p>BRAND</p>
          <input type="checkbox" onClick={(e) =>filter('U.S. Polo Assn',e.currentTarget.checked)} /><span>U.S. Polo Assn</span>
          <br></br>
          <input type="checkbox" onClick={(e) =>filter('HIGHLANDER', e.currentTarget.checked)} /><span>HIGHLANDER</span>
          <br></br>
          <input type="checkbox" onClick={(e) =>filter('Fashion Victim',e.currentTarget.checked)} /><span>Fashion Victim</span>
          </Size>
        </Menu.Item>
        <br></br>
        ...
        <Menu.Item key="4" style={{listStyle:"none",paddingLeft:4}}>
          <Size>
          <p>SIZE</p>
          <input type="checkbox" onClick={(e) =>filter('XL',e.currentTarget.checked)} /><span>XL</span>
          <br></br>
          <input type="checkbox" onClick={(e) =>filter('L',e.currentTarget.checked)} /><span>L</span>
          <br></br>
          <input type="checkbox" onClick={(e) =>filter('M',e.currentTarget.checked)} /><span>M</span>
           </Size>
        </Menu.Item>
      </Menu>
    </Sider>
